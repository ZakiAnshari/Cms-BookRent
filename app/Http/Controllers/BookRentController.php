...
class BookRentController extends Controller
{
    ...
    {  
        ...
        if($countData == 1){
            ...
            Session::flash('message', 'Buku yang di pinjam Sukses Di Kembalikan');
    ...
    public function store(Request $request)
    {
        ...
        if($book['status'] != 'in stock'){
            Session::flash('message', 'Tidak bisa di pinjam ');
            Session::flash('alert-class', 'alert-danger');
            ...
            ->count();
            if($count >= 3){
                Session::flash('message', 'Tidak bisa di pinjam , udah sampai batasan ');
                Session::flash('alert-class', 'alert-danger');
                return redirect('book-rent');
            } 
            else{
                try {
                    ...
                    Session::flash('message', 'Sewa BukuBerhasil');
                    Session::flash('alert-class', 'alert-success');
                    return redirect('book-rent');
