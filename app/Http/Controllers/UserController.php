...
class UserController extends Controller
{
    ...
    public function approve($slug)
    {
        ...
        $user->status = 'active';
        $user->save();
        return redirect('user-detail/'.$slug)->with('status','User Approved  Sukses');
    }
    ...
    public function destroy($slug)
    {
        $user = User::where ('slug', $slug)->first();
        $user->delete();
        return redirect('users')->with('status','User Deleted  Sukses');
    }
    ...
    public function restore($slug)
    {
        ...
        $user->restore();
        return redirect('users')->with('status','User Restore  Sukses');
    }
}
